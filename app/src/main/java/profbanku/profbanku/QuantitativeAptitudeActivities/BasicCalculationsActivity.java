...
public class BasicCalculationsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_basic_calculations);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_basic_calculations);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerBC);
