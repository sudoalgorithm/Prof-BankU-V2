...
public class GeometryActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_geometry);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_geometry);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerGeo);
