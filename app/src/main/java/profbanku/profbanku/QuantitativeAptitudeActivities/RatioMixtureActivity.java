...
public class RatioMixtureActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_ratio_mixture);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_ratio_mixture);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerRM);
