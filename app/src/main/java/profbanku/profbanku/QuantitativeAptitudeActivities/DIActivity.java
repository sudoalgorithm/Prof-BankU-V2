...
public class DIActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_di);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_di);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerDI);
