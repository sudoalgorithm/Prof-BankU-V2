...
public class BoatsStreamsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_boats_streams);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_boats_streams);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerBS);
