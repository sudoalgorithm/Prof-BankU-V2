...
public class AveragesActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_averages);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_averages);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerAverage);
