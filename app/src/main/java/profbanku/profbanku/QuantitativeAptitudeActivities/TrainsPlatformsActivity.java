...
public class TrainsPlatformsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_trains_platforms);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_trains_platforms);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerTrain);
