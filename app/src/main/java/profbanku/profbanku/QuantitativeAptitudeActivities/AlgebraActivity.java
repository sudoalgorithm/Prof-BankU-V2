...
public class AlgebraActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_algebra);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_algebra);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerAlgebra);
        ...
        mLinearLayout2 = (LinearLayout) findViewById(R.id.childLayoutAL);
        getLayoutInflater().inflate(R.layout.activity_child_layout_al, mLinearLayout2);
    }
