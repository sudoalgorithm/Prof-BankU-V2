...
public class SpeedDistanceTimeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_speed_distance_time_activiy);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_speed_distance_time_activiy);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerSDT);
