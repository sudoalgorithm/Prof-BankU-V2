...
public class ProfitLossActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_profit_loss);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_profit_loss);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerPL);
