...
public class PermutationsCombinationsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_permutations_combinations);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_permutations_combinations);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerPC);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        ...
        if (!b){
            youTubePlayer.cuePlaylist("PLBUmbdCAjoerUtArwOboDZG6bdMRGl243");
        }
