...
public class Mensuration2DActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_mensuration2_d);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_mensuration2_d);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerMen2D);
