...
public class ProbabilityActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_probability);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_probability);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerPro);
