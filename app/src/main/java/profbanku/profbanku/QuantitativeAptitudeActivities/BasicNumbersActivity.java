...
public class BasicNumbersActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_basic_numbers);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_basic_numbers);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerBN);
