...
public class CISIActiviy extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_cisiactiviy);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_cisiactiviy);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerCISI);
