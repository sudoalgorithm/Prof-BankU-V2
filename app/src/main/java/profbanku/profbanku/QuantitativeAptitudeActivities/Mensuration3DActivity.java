...
public class Mensuration3DActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_mensuration3_d);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_mensuration3_d);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerMen3D);
