...
public class HCFLCMActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_hcflcm);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_hcflcm);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerHCFLCM);
