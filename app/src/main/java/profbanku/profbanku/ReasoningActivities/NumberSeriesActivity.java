...
public class NumberSeriesActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_number_series);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_number_series);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerNS);
