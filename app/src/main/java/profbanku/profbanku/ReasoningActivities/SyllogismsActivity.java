...
public class SyllogismsActivity extends YouTubeBaseActivity implements  YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_syllogisms);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_syllogisms);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerSyllogisms);
