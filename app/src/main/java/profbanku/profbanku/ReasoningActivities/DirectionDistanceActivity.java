...
public class DirectionDistanceActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_direction_distance);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_direction_distance);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerDD);
