...
public class InputOutputActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_input_output);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_input_output);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerIO);
