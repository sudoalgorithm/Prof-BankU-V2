...
public class CodingDecodingActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_coding_decoding);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_coding_decoding);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerCD);
