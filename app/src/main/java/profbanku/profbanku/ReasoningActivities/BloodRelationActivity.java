...
public class BloodRelationActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_blood_relation);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_blood_relation);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerBR);
