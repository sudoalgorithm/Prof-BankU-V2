...
public class LogicalReasoningActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_logical_reasoning);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_logical_reasoning);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerLR);
