...
public class RankingOrderingActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, AppCompatCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppCompatDelegate.setContentView(R.layout.activity_ranking_ordering);
        mLinearLayout = (LinearLayout) findViewById(R.id.activity_ranking_ordering);
        mYoutubePlayerView = (YouTubePlayerView) findViewById(R.id.youtubePlayerRO);
